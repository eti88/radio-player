...
class Api {
  ...
  getPodcasts() {
    return fetch(`${this.url}/podcast`).then(response => response.json())
  }

  getPodcast(slug) {
    return fetch(`${this.url}/podcast/${slug}`).then(response => response.json())
  }

  getPodcastEpisodes(slug) {
    return fetch(`${this.url}/podcast/${slug}/episodes`).then(response => response.json())
  }
